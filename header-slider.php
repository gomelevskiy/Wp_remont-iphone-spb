...
<div id="myCarousel" class="carousel slide" data-ride="carousel" style="position: relative;">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img class="first-slide" src="<?php the_field('слайд_1',16); ?>" alt="<?php bloginfo('name'); ?>">
            <div class="container">
                <div class="carousel-caption">
                    <p><?php the_field('текст_1',16); ?></p>
                    <p><a class="btn btn-lg btn-primary" href="<?php the_field('ссылка_1',16); ?>" role="button">Подробнее</a></p>
                </div>
            </div>
        </div>
        <div class="item">
            <img class="first-slide" src="<?php the_field('слайд_2',16); ?>" alt="<?php bloginfo('name'); ?>">
            <div class="container">
                <div class="carousel-caption">
                    <p><?php the_field('текст_2',16); ?></p>
                    <p><a class="btn btn-lg btn-primary" href="<?php the_field('ссылка_2',16); ?>" role="button">Подробнее</a></p>
                </div>
            </div>
        </div>
        <div class="item">
            <img class="first-slide" src="<?php the_field('слайд_3',16); ?>" alt="<?php bloginfo('name'); ?>">
            <div class="container">
                <div class="carousel-caption">
                    <p><?php the_field('текст_3',16); ?></p>
                    <p><a class="btn btn-lg btn-primary" href="<?php the_field('ссылка_3',16); ?>" role="button">Подробнее</a></p>
                </div>
            </div>
        </div>
        <div class="item">
            <img class="first-slide" src="<?php the_field('слайд_4',16); ?>" alt="<?php bloginfo('name'); ?>">
            <div class="container">
                <div class="carousel-caption">
                    <p><?php the_field('текст_4',16); ?></p>
                    <p><a class="btn btn-lg btn-primary" href="<?php the_field('ссылка_4',16); ?>" role="button">Подробнее</a></p>
                </div>
            </div>
        </div>
    </div>
...
<div class="row block-info center-block" style="position: relative; border-top: 1px solid #000; background-color: rgba(0, 0, 0, 0.7);">
